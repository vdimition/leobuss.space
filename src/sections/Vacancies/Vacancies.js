...
const Vacancies = () => {
  ...
  return (
    <div className={styles.wrapper} id="vacancies">
        ...
        <div className={styles.card}>
          <div className={styles.cardContent}>
            ...
            <div className={styles.description}>
              ...
              оптимальних управлінських рішень з метою його стабільного функціонування на короткострокову та
              довгострокову перспективу.
            </div>
          </div>
          <div>
            <button type="button" className={styles.btnContactUs} onClick={openWidget}>
              зв’язатись із нами
